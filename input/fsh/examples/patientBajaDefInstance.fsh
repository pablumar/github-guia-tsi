...
Alias: $comprobacionINDEFCS = http://sns.gob.es/fhir/TSI/CodeSystem/estadoIndefCS

Instance: BBBBBBBBBB009932
InstanceOf: PatientSNS
Title: "Paciente Pasivo por Defunción SNS"
Description: "Paciente Pasivo por Defunción SNS"
Usage: #example
...
* extension[=].valueCoding = $estadosCS#2 "BAJA POR DEFUNCION"
* extension[+].url = "http://sns.gob.es/fhir/TSI/StructureDefinition/estado-comprobacion-indef"
* extension[=].valueCoding = $comprobacionINDEFCS#3 "Validado automático"
